  ...
  return (
    <>
      <Container component={'section'} maxWidth={false} disableGutters sx={{ marginTop: 5 }} >
        {/* title section */}
        <Box component={"section"} sx={{ backgroundImage: "url(/background1.png)", width: "95vw", height: { xs: "100vh", lg: "100vh" }, backgroundRepeat: "no-repeat", backgroundPosition: "center center", backgroundSize: "cover", margin: "10px auto", borderRadius: 9, display: "flex", flexDirection: { xs: "column", lg: "row" }, justifyContent: { xs: "center", lg: "space-around" }, padding: { xs: 2, lg: 0 } }}>
        ...
        <Container component={"section"} maxWidth={false} disableGutters sx={{ display: "flex", flexDirection: { xs: "column", md: "row" }, justifyContent: "space-evenly", marginTop: { xs: 2, lg: 20 }, paddingInline: { xs: 2, lg: 0 } }}>
        ...
        <Box component={"section"}>
          <Typography component={"h3"} variant="h3" fontSize={{ xs: 20, lg: 27 }} pl={4} py={5} sx={{ lineHeight: 1.5 }}>FIND OUT WHAT PEOPLE ARE SAYIG ABOUT QUENX</Typography>
