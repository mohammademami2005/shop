...
export default function Page() {
    ...
    return (
        ...
        <Container maxWidth={false} disableGutters sx={{ display: "flex", flexDirection: { xs: "column", lg: 'row' }, justifyContent: "space-evenly", padding: { xs: 1, lg: 5 } }} >
            <Stack direction={"column"} width={{ xs: "100%", lg: "60%" }} >
            ...
            <Box position={"relative"} width={{ xs: '100%', lg: "30%" }} marginTop={{ xs: 4, lg: 0 }} >
