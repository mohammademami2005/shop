                ...
                <Stack direction={'column'} useFlexGap width={"20%"} position={"relative"} >
                    <Stack gap={2} direction={"column"} width={"100%"} className="sticky top-0 left-0 " >
                        ...
                        <Stack direction={"column"} alignItems={"start"}>
                            <Button variant='text' sx={{ color: theme.palette.text.primary }} onClick={() => setFilter({ type: "all", value: 'All Product' })}>All Product</Button>
                            <Button variant='text' sx={{ color: theme.palette.text.primary }} onClick={() => setFilter({ type: 'bestSells', value: 'bestSells' })}>Best Sells</Button>
                            <Button variant='text' sx={{ color: theme.palette.text.primary }} onClick={() => setFilter({ type: 'category', value: "active-qx" })}>Active QX</Button>
                            <Button variant='text' sx={{ color: theme.palette.text.primary }} onClick={() => setFilter({ type: "category", value: 'artisanal' })}>Artisanal</Button>
                            <Button variant='text' sx={{ color: theme.palette.text.primary }} onClick={() => setFilter({ type: "category", value: "kids" })}>Kids</Button>
                        </Stack>
